...
class PostModelTest(TestCase):
    ...
    def test_models_have_correct_object_names(self):
        """Проверяем, что у моделей корректно работает __str__. У Post текст
        обрезается lо 30 символов, у Group выводится наименование группы."""
        post_str = self.post.text[:30]
